...
def predict():
	regressor = load_model('gru.h5',compile=False)
	...
	return render_template('output.html', prediction_text='Price at day {} would be ₹ {}'.format(len(output),output[-1]),user_image = img_url )
